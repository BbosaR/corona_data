...
```{r echo=TRUE}
death_global_url <- "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master
/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv"

raw_death_global <- read.csv(file =death_global_url, stringsAsFactors = FALSE, fill =FALSE)
...
```{r echo=TRUE}
raw_recoveries <- read.csv(file = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19
