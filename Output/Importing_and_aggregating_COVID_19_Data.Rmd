...
```{r}
setwd("C:/Users/uganda/OneDrive - BBOSA ROBERT/COVID-19/COVID-19_Data/Output/")
...
opts_knit$set(root.dir = "C:/Users/uganda/OneDrive - BBOSA ROBERT/COVID-19/COVID-19_Data/Output/")
```
```
...
df_conf1$date <- as.Date(paste(df_conf1$year, df_conf1$month, df_conf1$day, sep = "-"))
